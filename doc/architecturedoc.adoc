...
= Architecture Documentation of Tournament Companion
This document describes the architecture of the Tournament Companion hosted on github: https://github.com/chris2k2/tournamentcompanion
